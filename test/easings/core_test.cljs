...
(deftest sine
  (are [result f] (= result (map f INPUTS))
...
(deftest cubic
  (are [result f] (= result (map f INPUTS))
    ...
    [0 0.3185279999999999 0.875 0.999657 1] sut/ease-out-cubic
...
(deftest back
  (are [result f] (= result (map f INPUTS))
    ...
    [2.220446049250313e-16 0.4766524262399998 1.0876975 1.00741110006 1] sut/ease-out-back
